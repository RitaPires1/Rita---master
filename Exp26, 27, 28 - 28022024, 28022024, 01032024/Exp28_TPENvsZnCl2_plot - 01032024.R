...
filtered_strain <- Exp28_v5 %>% filter (Strain == "5001")

filtered_strain <- Exp28_v5 %>% filter (Strain == "5002")

filtered_strain <- Exp28_v5 %>% filter (Strain == "5003")

filtered_strain <- Exp28_v5 %>% filter (Strain == "5004")
