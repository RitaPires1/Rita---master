setwd("~/ITQB/Plate readings/Exp4_6plates_25102023")
...
Exp4_v2$TPEN_conc <- factor(Exp4_v2$TPEN_conc, levels = c("ctrTPENcells", 
                                                          "ctrTPEN",
                                                          "1.2",
                                                          "2.4",
                                                          "3.6",
...
Exp4_v2 <- Exp4_v2 %>% mutate(TPEN_conc = recode (TPEN_conc,
                                                  "ctrTPENcells" = "blank" ,
                                                  "ctrTPEN" = "0 uM",
                                                  "1.2" = "6 uM",
                                                  "2.4" = "12 uM",
...
Exp4_v2$Strain <- factor(Exp4_v2$Strain, levels = c("5001",
                                                    "5002",
                                                    "5003",
                                                    "5004",
                                                    "5006",
...
Exp4_v5 <- Exp4_v4 %>%
  group_by(Time_h, Strain, Transfer_medium, TPEN_conc) %>%
